...
const menu1 = (
    <Menu
        items={[
            {
                label: (
                    <p style={{ width: '500px' }}>A Bobbi Brown bestseller—a primer plus moisturization for smooth makeup application (it's the best of both worlds). Rich in feel, but never greasy, this advanced oil-free face formula, with Shea Butter, instantly hydrates, softens and cushions skin.
                        ...
                        Address of Mfg / Brand: the Estée Lauder Companies INC,767,fifth Avenue,New York,10153,United States of America<br></br><br></br>
                        Name and address of the importer - ELCA Cosmetics Pvt. Ltd, 202-206 Tolstoy House,15 Tolstoy Marg, New Delhi 110001, India</p>
                ),
            },
        ]}
    />
...
const menu2 = (
    <Menu
        items={[
            {
                label: (
                    <p style={{ width: '500px' }}>Normal to oily skin types.</p>
                ),
            },
        ]}
    />
...
const menu3 = (
    <Menu
        items={[
            {
                label: (
                    <p style={{ width: '500px' }}>This oil-free formula combines the moisturizing power of Shea Butter with Vitamins B, C and E. Grapefruit and Geranium fragrances leave a light, uplifting</p>
                ),
            },
        ]}
    />
...
const menu4 = (
    <Menu
        items={[
            {
                label: (
                    <p style={{ width: '500px' }}>Apply to just-cleansed skin, avoiding eye area.</p>
                ),
            },
        ]}
    />
...
export const ProductDetails = () => {
    // console.log(Review);
    const [imgsrc, setImgsrc] = useState("https://www.bobbibrown.in/media/export/cms/products/v2_1080x1080/bb_sku_E1LM01_1080x1080_0.jpg");
        ...
        <div>
            <div id="mainProducts_div">
                <div className='left_div'>
                    <p style={{ textAlign: "left" }}>Lip Care/Lip Balm</p>   {/* Products tag or title */}
                    <div className='imgsection'>
                        <div>
                            <button value onClick={handleImg}><img src="https://www.bobbibrown.in/media/export/cms/products/v2_1080x1080/bb_sku_E1LM01_1080x1080_0.jpg"></img></button>
                            <button onClick={handleImg}><img src='https://www.bobbibrown.in/media/export/cms/products/v2_1080x1080/bb_prod_7485_1080x1080_0.jpg'></img></button>
                            <button onClick={handleImg}><img src='https://www.bobbibrown.in/media/export/cms/products/v2_1080x1080/bb_prod_7485_1080x1080_1.jpg'></img></button>
                        </div>
                        <div>
                            <img src={imgsrc}></img>
                        </div>
                ...
                <div className='details_section'>
                    <div className='left_details1'>
                        ...
                        <p>Category</p>
                        <p>Mfg Date (Use Before 36 months from manufacturing date) 02/2021</p>
                        <BButton>ADD TO BAG</BButton><br></br>
                        <b>MINI BEAUTY. MORE LOVE.</b>
                        <br></br><br></br>
                        <b>Buy 2 minis and pick 1 free,
                            Or, get a Keychain and 2 samples on a Mini*.</b>
                        <br></br><br></br>
                        <Dropdown overlay={menu1}>
                            <a style={{ color: 'black', fontSize: '15px', fontWeight: 'bold' }} onClick={e => e.preventDefault()}>
                                <Space>
                                    WHAT IS IT
                                    <DownOutlined />
                                </Space>
                    ...
                    <div className='right_details1'>
                        <h4>Rs 5800</h4>{/* PRODUCT PROCE HERE*/}
                        <p>MRP inclusive of ll taxes |</p>
                        <p>50 ml</p>
                        <div style={{display:'flex', alignContent:'center'}}><p>(2708 Reviews)  .</p><StarFilled /> <StarFilled /> <StarFilled /> <StarFilled /></div>
            ...
            <div>
                ...
                <div className='flexdiv'>
                    <div>
                        ...
                        <ul>
                            ...
                            <li>95% said it left skin feeling healthy and infused with moisture *</li>
                            <li>95% said it layers well with makeup, helping makeup apply smoother and evenly*</li>
                            <li>91% said it improved the look of foundation*</li>
                        </ul>
                        <p>*Consumer testing on 123 women after using product for one week.</p>
                    </div>
                ...
                <div >
                    ...
                    <div className='theflex' style={{width:'30%'}} >
                        <button id='left_btn' onClick={handlecontent}>NEW ENRICHED VITAMIN EYE BASE</button>
                        <button id='right_btn' onClick={handlecontent}>VITAMIN ENRICHED FACE BASE</button>
                        <hr/>
                    </div>
                    <div className='eye_face'>{eye_face==="left"?"Our #1 moisturizer-and-primer in one replenishes skin with a signature Nourishing Vitamin Blend.":"Awakens, softens, and nourishes undereyes with a daily dose of multivitamin moisture"}</div>
                    <div className='eye_face_images'>
                        <div> <img src='https://www.bobbibrown.in/media/export/cms/collections/VEEB/FY21_VEEB_Comparison_VEEB2_PC.jpg'></img></div>   
                    </div>
                </div>
                <div>
                ...
                <div className='rating_section'>
                    <div>
                    <StarFilled style={{fontSize:"20px"}}/><StarFilled style={{fontSize:"20px"}}/><StarFilled style={{fontSize:"20px"}}/><StarFilled style={{fontSize:"20px"}}/><StarFilled style={{fontSize:"20px"}}/>
                ...
                <div className='all_reviews'>
                    {Review.map((e)=>(
                        <div className='review_content'>
                            <div>{e.stars===5?<><StarFilled /><StarFilled /><StarFilled /><StarFilled /><StarFilled /></>:e.stars===4?<><StarFilled /><StarFilled /><StarFilled /><StarFilled /></>:e.stars===3?<><StarFilled /><StarFilled /><StarFilled /></>:<><StarFilled /><StarFilled /></>}
                            <h3><b>{e.title}</b></h3><br></br>
                            <p>{e.body}</p>
                            {e.response?<p><u>REPLY FROM BOBBY BROWN:  </u>{e.response}</p>:""}
                            <p>{e.recommend}</p>
                            </div>
                            <div>
