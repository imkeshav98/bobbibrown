...
export default function Signup() {
  ...
  return (
    <div className='Signup_div'>
      ...
      <h6>Sign up for emails and be the first to know
          <br/>
           about exclusive offers, pre-sales, new 
           <br/>
           collections and more.</h6>
           <input className="inputOfSignUp" type="text" placeholder="ENTER YOUR EMAIL" />
           <br />
           <br />
           <p className='WeLoveBirthday'>WE LOVE BIRTHDAYS</p>
           {/* <br /> */}
           <p>Tell us your birthday and we'll send you a  <br /> special surprise on your big day.</p>
           <div className="inputMonthSelect">
           <select class="form-select selecttagOFInput" aria-label="Default select example">
...
<select class="form-select selecttagOFInput" aria-label="Default select example">
  ...
  <option value="31">31</option>
           ...
           <p>By clicking "Submit", I agree to the Bobbi Brown <br/>
